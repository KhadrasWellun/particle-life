...
public:
	...
	float InterEvoChance = 0.2;
	float InterEvoAmount = 0.3;
	...
	float probabilityθα = 0;
	float probabilityθβ = 0;
	float probabilityθγ = 0;
	float probabilityθδ = 0;
	float probabilityθε = 0;
	float probabilityθζ = 0;
	float probabilityθη = 0;
	...
	float viscosityαθ = 0.7F;
	float viscosityβθ = 0.7F;
	float viscosityγθ = 0.7F;
	float viscosityδθ = 0.7F;
	float viscosityεθ = 0.7F;
	float viscosityζθ = 0.7F;
	float viscosityηθ = 0.7F;
	float viscosityθα = 0.7F;
	float viscosityθβ = 0.7F;
	float viscosityθγ = 0.7F;
	float viscosityθδ = 0.7F;
	float viscosityθε = 0.7F;
	float viscosityθζ = 0.7F;
	float viscosityθη = 0.7F;
	float viscosityθθ = 0.7F;
