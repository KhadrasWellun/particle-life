...
{
	lastTime = clock();
	ofSetWindowTitle("Particle Life - 8c64v64p version 1.7.7.1");
	...
	MinMaxGroup.add(minPowerSlider.setup("minimum power", minP, -300, 300));
	MinMaxGroup.add(maxPowerSlider.setup("maximum power", maxP, -300, 300));
