...
void ofApp::restart()
{
	if (numberSliderα > 0) { alpha = CreatePoints(numberSliderα, 0, 0, ofRandom(128, 255)); }
	if (numberSliderβ > 0) { betha = CreatePoints(numberSliderβ, 0, ofRandom(128, 255), 0); }
	if (numberSliderγ > 0) { gamma = CreatePoints(numberSliderγ, ofRandom(128, 255), 0, 0); }
	if (numberSliderδ > 0) { elta = CreatePoints(numberSliderδ, ofRandom(128, 255), ofRandom(128, 255), 0); }
	if (numberSliderε > 0) { epsilon = CreatePoints(numberSliderε, ofRandom(128, 255), 0, ofRandom(128, 255)); }
	if (numberSliderζ > 0) { zeta = CreatePoints(numberSliderζ, 0, ofRandom(128, 255), ofRandom(128, 255)); }
	if (numberSliderη > 0) { eta = CreatePoints(numberSliderη, ofRandom(128, 255), ofRandom(128, 255), ofRandom(128, 255)); }
...
{
	lastTime = clock();
	ofSetWindowTitle("Particle Life - 7+1c64v64p version 1.7.4");
	...
	gui.add(attractDarkButton.setup("attractDark (j)"));
	gui.add(repulseDarkButton.setup("repulseDark (k)"));
	gui.add(freezeButton.setup("Freeze (f)"));
	...
	globalGroup.add(evoToggle.setup("Evolve parameters", false));
	...
	MinMaxGroup.add(minPowerSlider.setup("minimum power", minP, -200, 0));
	MinMaxGroup.add(maxPowerSlider.setup("maximum power", maxP, 0, 200));
	MinMaxGroup.add(minRangeSlider.setup("minimum range", minR, 0, 100));
	MinMaxGroup.add(maxRangeSlider.setup("maximum range", maxR, 100, 500));
	MinMaxGroup.add(minViscoSlider.setup("minimum viscosity", minV, 0.0, 0.5));
	MinMaxGroup.add(maxViscoSlider.setup("maximum viscosity", maxV, 0.5, 1.0));
	MinMaxGroup.add(minProbSlider.setup("minimum probability", minI, 0, 50));
	MinMaxGroup.add(maxProbSlider.setup("maximum probability", maxI, 50, 100));
	gui.add(&MinMaxGroup);
	...
	tetaGroup.add(powerSliderαθ.setup("power alpha x teta:", ppowerSliderαθ, minP, maxP));
	tetaGroup.add(powerSliderβθ.setup("power betha x teta:", ppowerSliderβθ, minP, maxP));
	tetaGroup.add(powerSliderγθ.setup("power gamma x teta:", ppowerSliderγθ, minP, maxP));
	tetaGroup.add(powerSliderδθ.setup("power delta x teta:", ppowerSliderδθ, minP, maxP));
	tetaGroup.add(powerSliderεθ.setup("power epsilon x teta:", ppowerSliderεθ, minP, maxP));
	tetaGroup.add(powerSliderζθ.setup("power zeta x teta:", ppowerSliderζθ, minP, maxP));
	tetaGroup.add(powerSliderηθ.setup("power eta x teta:", ppowerSliderηθ, minP, maxP));
	...
	tetaGroup.add(vSliderαθ.setup("radius alpha x teta:", pvSliderαθ, minR, maxR));
	tetaGroup.add(vSliderβθ.setup("radius betha x teta:", pvSliderβθ, minR, maxR));
	tetaGroup.add(vSliderγθ.setup("radius gamma x teta:", pvSliderγθ, minR, maxR));
	tetaGroup.add(vSliderδθ.setup("radius delta x teta:", pvSliderδθ, minR, maxR));
	tetaGroup.add(vSliderεθ.setup("radius epsilon x teta:", pvSliderεθ, minR, maxR));
	tetaGroup.add(vSliderζθ.setup("radius zeta x teta:", pvSliderζθ, minR, maxR));
	tetaGroup.add(vSliderηθ.setup("radius eta x teta:", pvSliderηθ, minR, maxR));
	...
	tetaGroup.add(viscositySliderαθ.setup("Viscosity alpha x teta", viscosityαθ, minV, maxV));
	tetaGroup.add(viscositySliderβθ.setup("Viscosity betha x teta", viscosityβθ, minV, maxV));
	tetaGroup.add(viscositySliderγθ.setup("Viscosity gamma x teta", viscosityγθ, minV, maxV));
	tetaGroup.add(viscositySliderδθ.setup("Viscosity delta x teta", viscosityδθ, minV, maxV));
	tetaGroup.add(viscositySliderεθ.setup("Viscosity epsilon x teta", viscosityεθ, minV, maxV));
	tetaGroup.add(viscositySliderζθ.setup("Viscosity zeta x teta", viscosityζθ, minV, maxV));
	tetaGroup.add(viscositySliderηθ.setup("Viscosity eta x teta", viscosityηθ, minV, maxV));
	...
	tetaGroup.add(probabilitySliderαθ.setup("Probability alpha x teta", probabilityαθ, minI, maxI));
	tetaGroup.add(probabilitySliderβθ.setup("Probability betha x teta", probabilityβθ, minI, maxI));
	tetaGroup.add(probabilitySliderγθ.setup("Probability gamma x teta", probabilityγθ, minI, maxI));
	tetaGroup.add(probabilitySliderδθ.setup("Probability delta x teta", probabilityδθ, minI, maxI));
	tetaGroup.add(probabilitySliderεθ.setup("Probability epsilon x teta", probabilityεθ, minI, maxI));
	tetaGroup.add(probabilitySliderζθ.setup("Probability zeta x teta", probabilityζθ, minI, maxI));
	tetaGroup.add(probabilitySliderηθ.setup("Probability eta x teta", probabilityηθ, minI, maxI));
